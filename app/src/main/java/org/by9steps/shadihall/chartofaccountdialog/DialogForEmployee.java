...
public class DialogForEmployee extends DialogFragment implements View.OnClickListener,
        AdapterView.OnItemSelectedListener {
    public static final String DIALOG_EDIT_TEXT_TITLE ="Edit";
    public CustomDialogOnDismisListener listener;
    //////////Change null to Null
    ////////////////////////////Remove Restrictioin from all except Name

    //////////////////POp up not close after inserting account
    ///////////////////count The consective Record
    View customView;
    TextInputLayout name_layout;///Mandatory
    ...
    TextInputLayout salary_layout;//// if null 0
    ...
    String groupID = null;
    int count = 0;
    //////////////////// Type Check for Employee Either Edit of Create
    String  dialogtype="open";
    /////////////Get Editable info via intent
    String groupName = "";
////////////////////////////////Used For EDit Record
    String dbpkID="";
    String acnameid="";
    @Override
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        customView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_for_emp, null);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.add && dialogtype.equals(DIALOG_EDIT_TEXT_TITLE)){
            ...
            if (databaseHelper.findAccount3Name(querydb)) {
                ...
                if (groupName.equals("Employee") || groupID.equals("2")) {
                    querydb = "Update Account3Name SET AcName = '" + name.getText().toString() + "', AcAddress = '" + address.getText().toString() + "', AcMobileNo = '" + login_mobile.getText().toString()
                            ...
                            + "', SecurityRights = '" + spPosition + "', Salary = '" + salary.getText().toString() + "', UpdatedDate = 'Null' WHERE AcNameID = " + acnameid+" AND ID = "+dbpkID;
...
//
//            }
//            else if (!inputValidation.isInputEditTextFilled(salary, salary_layout, getString(R.string.error_message_salary))) {
//                MNotificationClass.ShowToast(getContext(), "Some Field May empty");
//
//            }
...
//            }
                ...
                if (databaseHelper.findAccount3Name(query)) {
                ...
                } else if(prefrence.getClientUserIDSession()==null){
                    MNotificationClass.ShowToast(getContext(),"Client User ID not Exist");
                } else {

                    String saalary=salary.getText().toString();
                    ...
                    Account3Name account3Nametem = new Account3Name(
                            ...
                            saalary);
                    account3Nametem.setAccountPhoto(GenericConstants.NullFieldStandardText);
